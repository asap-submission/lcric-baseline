...
def main():
    ...
    parser.add_argument('--H', default=1, type=int,help='Number of heads in the temporal decoder')
    ...
    parser.add_argument('--tbx_folder', default='../tbx_folder', type=str)
    parser.add_argument('--acc_txt', default='../save_acc/', type=str)
